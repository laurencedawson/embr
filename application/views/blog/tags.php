...
if( isset( $posts ) ){
  foreach($posts as $post){
    if(strlen($post["image"])){
      ...
      echo "<div class=\"post index\" style=\"height:".$height."px; padding:0px\" >";	       echo "<a href=\"".base_url().strtolower(url_title($post["title"]))."\"><img src=\"".base_url()."img/uploads/".$post["image"]."\" width=\"574\" height=\"".$height."\"/></a>";			   
    }else{
